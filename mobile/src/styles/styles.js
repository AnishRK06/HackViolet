...
const styles = StyleSheet.create({
  ...
  cardActionText: { fontSize: 14, color: COLORS.accent.primary, fontFamily: 'CormorantGaramond_600SemiBold' },
  ...
  navRouteInfo: { backgroundColor: 'rgba(52, 199, 89, 0.15)', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 12, marginBottom: 10, alignSelf: 'flex-start' },
  navRouteInfoText: { color: COLORS.accent.success, fontSize: 14, fontWeight: '600', fontFamily: 'CormorantGaramond_600SemiBold' },
