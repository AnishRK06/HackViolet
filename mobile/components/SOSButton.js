...
export default function SOSButton() {
  ...
  return (
    <>
      <Animated.View style={[
        styles.container,
        { transform: [{ scale: activated ? pulseAnim : 1 }] }
      ]}>
        <TouchableOpacity
          style={[styles.button, activated && styles.buttonActive]}
      ...
      <Modal visible={showModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <TouchableOpacity style={styles.closeButton} onPress={cancelEmergency}>
              <X color="#fff" size={24} />
            </TouchableOpacity>
